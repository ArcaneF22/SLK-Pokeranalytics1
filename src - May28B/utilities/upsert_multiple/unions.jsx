...
export const MultipleUnions = () => {
    ...
    const functionCSVtoJSON = (csvArray) => {
        if (!Array.isArray(csvArray)) {
            ...
            if(headerROW[0] != "idd" || headerROW[1] != "Union" || headerROW[2] != "app" || headerROW[3] != "union" || headerROW[4] != "status"){
        ...
        <div className="ui segment basic">
          {
            ...
            <>
                ...
                <a className='ui button purple' href='./csv/csv_unions.csv'>Download CSV template</a>
            </>
            : 
